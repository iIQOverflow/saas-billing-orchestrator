    ...
    return (
        <main className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(56,189,248,0.12),_transparent_32%),linear-gradient(to_bottom,_#f6f8fb,_#eef3f8_46%,_#f7f9fc)] px-6 py-16 sm:px-8 sm:py-24">
            <div className="mx-auto flex min-h-[calc(100vh-8rem)] max-w-5xl items-center justify-center">
                <section className="login-shell w-full max-w-[480px] overflow-hidden rounded-[34px] border border-white/80 bg-white/92 px-6 py-8 shadow-[0_34px_90px_-52px_rgba(15,23,42,0.42)] backdrop-blur sm:px-8 sm:py-9">
                    <div className="rounded-[26px] border border-slate-200/70 bg-[linear-gradient(135deg,_rgba(248,250,252,0.92),_rgba(241,245,249,0.86))] px-5 py-5 sm:px-6">
