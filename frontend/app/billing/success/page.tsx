        ...
        <main className="min-h-screen bg-[linear-gradient(to_bottom,_#f8fafc,_#f1f5f9)] px-6 py-16 sm:px-8 sm:py-24">
            <div className="mx-auto flex max-w-2xl items-center justify-center">
                <section className="w-full overflow-hidden rounded-[26px] border border-slate-200 bg-white shadow-sm">
                    <div className="bg-[radial-gradient(circle_at_top_left,_rgba(16,185,129,0.12),_transparent_38%),linear-gradient(to_bottom,_#ffffff,_#f8fafc)] px-6 py-8 sm:px-8 sm:py-9">
                        ...
                        <p className="mt-3 max-w-xl text-sm leading-6 text-slate-600">
                            Your checkout was submitted. The billing change finishes in the
                            background, and the dashboard refreshes when you return.
                        </p>
                    </div>
